...
const Hero = () => {
  return (
    <div className="hero overflow-hidden">
      ...
      <div className="hero-text absolute sm:top-28 left-0 text-white mx-6 my-10 sm:mx-10 md:mx-10 lg:mx-20 text-center sm:text-left">
        ...
        <p className="text-gray-100 lg:w-2/3 mt-4 lg:mt-6  max-w-xl lg:max-w-7xl p-4 sm:p-0">

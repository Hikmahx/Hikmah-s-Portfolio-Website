...
const skills = [
  ...
  { name: 'Figma', icon: require('../assets/figma.svg').default },
  { name: 'Next.js', icon: require('../assets/nextjs.svg').default },
  { name: 'Redux', icon: require('../assets/redux.svg').default },
  { name: 'Git', icon: require('../assets/git.svg').default },
  { name: 'Github', icon: require('../assets/github.svg').default },
  { name: 'Sass', icon: require('../assets/sass.svg').default },
  { name: 'GraphQL', icon: require('../assets/graphql.svg').default },
  { name: 'MongoDB', icon: require('../assets/mongodb.svg').default },
  { name: 'Tailwind', icon: require('../assets/tailwindcss.svg').default },
  { name: 'Postman', icon: require('../assets/postman.svg').default },
  { name: 'Vercel', icon: require('../assets/vercel.svg').default },
  { name: 'VsCode', icon: require('../assets/visual-studio-code.svg').default },
  { name: 'Jest', icon: require('../assets/jest.svg').default },
  ...
  { name: 'Pinia', icon: require('../assets/pinia.svg').default }
]

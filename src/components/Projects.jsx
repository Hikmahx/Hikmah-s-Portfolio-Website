      ...
      <div className="container flex flex-wrap justify-center mx-auto">
        <div className="project bg-white relative overflow-hidden rounded-sm w-72 lg:w-80 shadow-md mx-4 my-6">
          <div className="img-wrapper relative w-72 lg:w-80 h-72 lg:h-80">
            <img className="w-full h-full object-cover" src={require('../assets/projects-images/sneakers-ecommerce-website.herokuapp.com.png')} alt="project-img" />
          </div>
          <div className="info p-6 flex flex-col justify-end">
            <h3 className="font-bold uppercase mb-3">SNEAKERS E-COMMERCE WEBSITE</h3>
            <p className="mb-4">
              A full stack application for buying sneakers. Users can create account update their info, password, and cart update,
               create and set default address, and view order history.
              </p>
            <div className="skills flex flex-wrap items-start mb-14">
              ...
              <div className="px-4 rounded-full m-1 bg-gray-200 text-gray-600">redux</div>
              ...
              <div className="px-4 rounded-full m-1 bg-gray-200 text-gray-600">node</div>
              <div className="px-4 rounded-full m-1 bg-gray-200 text-gray-600">express</div>
              <div className="px-4 rounded-full m-1 bg-gray-200 text-gray-600">mongoDB</div>
              <div className="px-4 rounded-full m-1 bg-gray-200 text-gray-600">stripe API</div>
            </div>
            <div className="links flex absolute bottom-6">
              <a target="_blank" className="font-semibold m-2" href="https://github.com/Hikmahx/sneakers-ecommerce-website" aria-label="github link">
                <img className="w-6 h-6" src={require('../assets/github.svg')} alt="icon" />
              </a>
              <a target="_blank" className="font-semibold m-2" href="https://sneakers-ecommerce-website.herokuapp.com/" aria-label="site link">

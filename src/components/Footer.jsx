    ...
    <footer style={{background:'#1c2431'}} className="text-white p-8 w-full">
      <div className="upper flex items-center justify-between">
        <div className="logo m-6 md:m-0">
          <a className="text-base" href="/">HY</a>
        </div>
        <div className="links flex justify-end">
          <a href="https://linkedin.com/in/hikmah-yousuph-449467204/" target="_blank" rel="noopener noreferrer" className="w-5 h-5 m-2" aria-label="linkedin link">
          ...
          <a href="https://github.com/Hikmahx" target="_blank" rel="noopener noreferrer" className="w-5 h-5 m-2" aria-label="github link">

    ...
    <footer style={{background:'#1c2431'}} className="text-white p-8 w-full">
      <div className="upper flex items-center justify-between">
        ...
        <div className="links flex justify-end">
          <a href="https://linkedin.com/in/hikmah-yousuph-449467204/"  className="w-5 h-5 m-2" aria-label="linkedin link">
          ...
          <a href="https://github.com/Hikmahx" className="w-5 h-5 m-2" aria-label="github link">
